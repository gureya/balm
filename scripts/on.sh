...
do
	...
	do
	    ...
	    #run_cmd "numactl --physcpubind=${cpus[$i]} /home/dgureya/parsec-3.0/ext/splash2x/apps/ocean_ncp/inst/amd64-linux.gcc/bin/ocean_ncp -n4098 -p${num_threads[$i]} -e1e-14 -r10000 -t14400"
		run_cmd "numactl --physcpubind=${cpus[$i]} /home/dgureya/parsec-3.0/ext/splash2x/apps/ocean_ncp/inst/amd64-linux.gcc/bin/ocean_ncp -n4098 -p${num_threads[$i]} -e1e-15 -r10000 -t12100"
		END=$(date +%s)
		DIFF=$(( $END - $START ))
