...
do
	...
	do
	    ...
	    run_cmd "numactl --physcpubind=${cpus[$i]} /home/dgureya/parsec-3.0/ext/splash2x/apps/ocean_cp/inst/amd64-linux.gcc/bin/ocean_cp -n4098 -p${num_threads[$i]} -e1e-15 -r10000 -t12100"
		END=$(date +%s)
		DIFF=$(( $END - $START ))
