...
//compiling: g++-8 client.cpp -o client -lboost_system -lboost_serialization -lpthread
// credits: https://stackoverflow.com/questions/9336010/how-to-read-a-fix-sized-packet-using-boost-asio
// credits: https://www.boost.org/doc/libs/1_53_0/doc/html/boost_asio/examples.html
...
void client() {
  ...
  try {
    ...
    if (!ec) {
      ...
      std::vector<CMYType> data { { i, 2, 3 }, { i, 5, 6 }, { i, 8, 9 }, { i,
          11, 12 }, { i, 14, 15 }, { i, 17, 18 }, { i, 20, 21 }, { i, 23, 24 },
          { i, 26, 27 }, { i, 29, 30 }, };
      ...
      data_out.outbound_header_ = header_stream.str();  //m_outbound_head == size in hexa in a std::string
